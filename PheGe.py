...
class PheGe:
        ...
        if length < 3:
            ...
            if args[3] != 'webweb' and args[3] != 'default':
                ...
                if args[3] == 'webweb':
                    ...
                    self.webweb = False
            if length is 5 and args[4][-4:] != '.png':
    ...
    """
    Prints the information about how to use PheGe
    """

    def help_information(self):
        print('Proper use of PheGe Search:')
        ...
        print('Example: python PheGe.py eeie-id-name.csv eeie-targets.csv default network-plot.png')


if __name__ == "__main__":
    p = PheGe()
    p.validate_input(sys.argv)
    p.load_files(sys.argv[1], sys.argv[2])
